...
public class ISB {
    ...
    public static ItemStackBuilder material(DataMaterial material) {
    ...
    public static ItemStack stack(DataMaterial material) {
        return stack(material.getMaterial(), material.getDamage());
    }
