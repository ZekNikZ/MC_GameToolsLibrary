...
public class ItemStackBuilder {
    ...
    public static ItemStackBuilder fromMaterial(DataMaterial material) {
        return fromMaterial(material.getMaterial(), material.getDamage());
    }
    ...
    public ItemStackBuilder material(DataMaterial material) {
        this.stack.setType(material.getMaterial());
        this.stack.setDurability(material.getDamage());
        return this;
    }
    ...
    public ItemStackBuilder lore(List<String> lore) {
        this.lore.addAll(lore.stream().map(line -> "" + ChatColor.RESET + ChatColor.GRAY + line).collect(Collectors.toList()));
        return this;
    }
